				...
				<div class="container-fluid">
					<div class="card shadow">
						...
						<div class="card-body">
							...
							<form action="<?= base_url('dashboard/proses_editdisposisi') ?>"
								...
								<div class="input-group date">
									<input type="text" class="form-control" name="tgl_disposisi" id="tgl_disposisi"
										placeholder="Tanggal Disposisi" value="<?= $tb['tgl_disposisi']?>">
								...
								<div class="form-group">
									<select class="form-control" id="tujuan" name="tujuan">
										<option selected="<?= $tb['tujuan']?>"><?= $tb['tujuan']?></option>
										<?php foreach($data_pilih as $d) { ?>
										<option value="<?php echo $d['jabatan'];?>"> <?php echo $d['jabatan']; ?>
										</option>
										<?php } ?>
									</select>
									...
									<div class="input-group date">
										<input type="text" class="form-control" name="isi" id="isi"
											placeholder="Isi Ringkas" value="<?= $tb['isi']?>">
										<div class="input-group-append">
											<div class="input-group-text"><i class="fa fa-calendar"></i></div>
										</div>
									</div>
									...
									<div class="form-group">
										<input type="text" class="form-control" name="sifat" id="sifat"
											placeholder="Sifat" value="<?= $tb['sifat']?>">
									</div>
								...
								<div class="input-group mb-3">
									<div class="custom-file">
										...
										<input type="text" class="form-control" name="arsip_lama"
											value="<?= $tb['arsip_disposisi']?>" hidden>
										<label class="custom-file-label" for="berkas">Choose file</label>
									</div>
									<?php if($tb['arsip_disposisi'] != '') { ?>
									<a class="btn btn-outline-secondary"
										href="<?= base_url().'assets/berkas/masuk/disposisi/'.$tb['arsip_disposisi'];?>"
										title="<?= $tb['arsip_disposisi']?>" target="_blank">Lihat File</a>
									<?php } ?>
									<?php if($tb['arsip_disposisi'] == '') { ?>
									<a class="btn btn-outline-secondary disabled" aria-disabled="true">Belum
										Diupload</a>
									<?php } ?>
								</div>
